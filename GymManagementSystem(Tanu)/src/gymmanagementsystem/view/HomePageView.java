...
public class HomePageView extends JFrame {
    ...
    public HomePageView() {
        ...
        aboutCard.add(aboutMainPanel, gbcAbout);

        // Remove all sign-in, registration, and role selection related code
        ...
        signInLabel.addMouseListener(new MouseAdapter() {
            public void mouseClicked(MouseEvent e) {
                // Remove the popup message and let the controller handle the navigation
            }
        });
    ...
    public void signInLabelNav(MouseListener l){
        signInLabel.addMouseListener(l);
    }
} 