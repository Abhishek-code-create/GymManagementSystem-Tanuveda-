...
public class DashBoardView extends javax.swing.JFrame {
    ...
    public DashBoardView() {
        ...
        profile.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                gymmanagesystem.model.personaldata model = new gymmanagesystem.model.personaldata();
                gymmanagesystem.view.PersonalInformation personalInfoView = new gymmanagesystem.view.PersonalInformation();
                gymmanagesystem.controller.personalcontroller controller = new gymmanagesystem.controller.personalcontroller(model, personalInfoView);
        ...
        jLabel2.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                gymmanagesystem.view.Reviewpage reviewPage = new gymmanagesystem.view.Reviewpage();
                gymmanagesystem.controller.ReviewController controller = new gymmanagesystem.controller.ReviewController(reviewPage);
                reviewPage.setController(controller);
                reviewPage.setLocationRelativeTo(null);
                reviewPage.setVisible(true);
            }
        });
        
        // Add click listener to Reminder label
        remainder.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        remainder.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                DashBoardView.this.setVisible(false);
                gymmanagesystem.view.reminderview reminderView = new gymmanagesystem.view.reminderview();
                reminderView.setLocationRelativeTo(null);
                reminderView.setVisible(true);
            }
        });
        
        // Add click listener to Products label
        order.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        order.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                DashBoardView.this.setVisible(false);
                gymmanagesystem.view.gymproducts productsView = new gymmanagesystem.view.gymproducts();
                productsView.setLocationRelativeTo(null);
                productsView.setVisible(true);
            }
        });
        
        // Add click listener to Notification label
        ...
        notification.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                NotificationShower shower = new NotificationShower(DashBoardView.this);
    ...
    private void initComponents() {
        ...
        getContentPane().add(notification, new org.netbeans.lib.awtextra.AbsoluteConstraints(1330, 150, 180, -1));
        ...
        getContentPane().add(profile, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 150, 120, -1));

        remainder.setBackground(new java.awt.Color(255, 255, 255));
        remainder.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        remainder.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ImagePicker/remaindericon.png"))); // NOI18N
        remainder.setText("Reminder");
        getContentPane().add(remainder, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 150, 160, -1));
        ...
        order.setText("Products");
        getContentPane().add(order, new org.netbeans.lib.awtextra.AbsoluteConstraints(1170, 150, 140, -1));
        ...
        jPanel4Layout.setVerticalGroup(
            jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addComponent(jCalendar1, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 304, Short.MAX_VALUE)
        );

        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 500, 510, 310));

        jLabel8.setBackground(new java.awt.Color(153, 153, 153, 80));
